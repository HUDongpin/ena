...
- Keep cleanup scoped to sessions owned by the task; use the session reference for the installed version’s lifecycle commands.
...
| Authoring tests | [Test generation](references/test-generation.md) |
| Multiple sessions, profiles | [Session management](references/session-management.md) |
...
Adapted from Microsoft Playwright Core 1.59.1; [LICENSE](LICENSE) and [NOTICE](NOTICE) retain upstream attribution.
