...
description: Migrate Phaser 3 code to Phaser 4 or resolve version-specific breaking changes and removed APIs.
---
...
**Related references:** [Phaser 4 features](../v4-new-features/SKILL.md), [Filter API](../v4-new-features/references/filters-api.md). Game configuration source: `src/core/typedefs/GameConfig.js` in the Phaser package.
