...
const trajectoryVersion = "0.2.0-implemented-unverified.12";
const trajectorySourceHead = "a8b63e853c28be665282eaa4e8010d4198319106";
...
const trajectoryPackageSha256 = "218faeb50147cff157e617cd43c7030ee38541de7e93b019510c4f75da684c28";
const trajectoryReceiptSha256 = "6e774f2a793ef4d3650067a3a77f1b24b2af205a95289b1cd6a1eade5e1d70a7";
const trajectoryCustodySha256 = "70f04bf5a4ae998462bf01a0361037b67f0c92a8862d90d32429200c90d01b23";
const trajectoryPackageIntegrity = "sha512-6C/V/XSs1wFUD5Xo8HHH8FIiZDYG7mX1y1EzW6WloDx+fziIMSpVX4kMReW3JillBUwD8TAIs9qc/2ngppj2Ng==";
...
test("Open ENA consumes the reviewed jENA source snapshot as an exact-version npm workspace", () => {
  ...
  assert.equal(
    ...
    `npm run verify:j3dena-vendor -- --require-installed && npm run jena:verify && ${runtimeVendorVerifyCommand} && npm run verify:production-browser-receipt && npm run test:app && npm run typecheck:app && npm run build:app`,
  );
