...
function OfficialPlotIcon({ name }: { name: OfficialPlotIconName }) {
  const paths: Record<OfficialPlotIconName, ReactNode> = {
  ...
  return <svg className="ena-official-action-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">{paths[name]}</svg>;
}
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={() => onZoomChange(boundedZoom(zoom - 0.2))}
      >
        <OfficialPlotIcon name="zoom-out" />
      </button>
      <button
        type="button"
      ...
      >
        <OfficialPlotIcon name="recenter" />
      </button>
      <button
        type="button"
...
function PlotPanelActionToolbar({
  ...
  return (
    ...
    >
      ...
      >
        <OfficialPlotIcon name={panelState === "hidden" ? "show" : "hide"} />
      </button>
      <button
        type="button"
