...
const inferenceEn: OpenEnaInferenceCopy = {
  ...
  mannWhitneyEndpointCaption: "Independent endpoint groups · Mann–Whitney U",
...
const inferenceZhHant: OpenEnaInferenceCopy = {
  ...
  degreesFreedom: "自由度",
  kendallsW: "Kendall’s W",
  mannWhitneyEndpointCaption: "獨立端點群組 · Mann–Whitney U 檢定",
...
const inferenceZhHans: OpenEnaInferenceCopy = {
  ...
  completeN: "完整 n",
  degreesFreedom: "自由度",
  mannWhitneyEndpointCaption: "独立端点组 · Mann–Whitney U 检验",
